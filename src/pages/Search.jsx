...
function Search() {
  ...
  return (
    ...
    //   <div className="rounded-lg border border-slate-300 p-5 h-fit sticky top-10 z-1">
    ...
    // <div className="grid grid-cols-1 lg:grid-cols-[250px_1fr] gap-6">
    //   {/* Sidebar Filters */}
    //   <aside className="rounded-lg border border-slate-300 p-5 h-fit sticky top-10 z-10">
    //     <div className="space-y-5">
    //       <h3 className="text-lg font-semibold border-b border-slate-300 pb-5">
    //         Filter by:
    //       </h3>
