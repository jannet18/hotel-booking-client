...
function Header() {
  ...
  return (
    ...
    //         <Link to="/">Vacation Stay</Link>
    //       </span>
    //     </div>
    //     <div className="hidden sm:flex flex-row items-center justify-center gap-6 text-white ">
    //       <button type="button" className="hover:bg-blue-600 rounded-sm p-1">
    //         KES
    //       </button>
    //       <button type="button" className="hover:bg-blue-600 rounded-sm p-1">
    //         flag
    ...
    //       <div className="bg-white p-1 rounded-sm border border-blue-600 text-blue-600">
    //         <Link to="/register">
    ...
    //       <section className="bg-white h-full p-8 absolute top-0 right-0 z-50 w-64 flex flex-col">
